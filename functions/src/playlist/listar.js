...
var util = []
    ...
    var res1 = await db.query(`CALL PCD_CANTAI_LISTA_PLAYLISTS_USUARIO(${req.jwt.id});`)
    var res2 = await db.query(`CALL PCD_CANTAI_LISTA_PLAYLISTS_COMPARTILHADA_USUARIO(${req.jwt.id});`)
